...
В переводе на более человеческий это значит: "Могу конкатенировать только строку со строкой (str), а строку с числом (int) не могу." int - это от "integer" - целое (не дробное) число; мы будем работать и с дробными числами, но потом.
