...
|            ---: |           ---: |            ---: | :---                                                 | :---                                                                 |
|               3 |              2 |               + | Result of addition: 5                                | См. выше                                                             |
|               3 |              2 |               - | Result of subtraction: 1                             |                                                                      |
|               0 |              0 |               + | Result of addition: 0                                | Тоже *happy path*, но с "граничными" значениями                      |
|               0 |              0 |               - | Result of subtraction: 0                             |                                                                      |
|              -3 |             -2 |               + | Result of addition: -5                               | Отрицательные числа тоже должны работать                             |
|              -3 |             -2 |               - | Result of subtraction: -1                            |                                                                      |
|   1000000000000 |  1000000000000 |               + | Result of addition: 2000000000000                    | См. комментарий после таблицы                                        |
|   1000000000000 |  1000000000000 |               - | Result of subtraction: 0                             |                                                                      |
|  -1000000000000 | -1000000000000 |               + | Result of addition: -2000000000000                   | См. комментарий после таблицы                                        |
|  -1000000000000 | -1000000000000 |               - | Result of subtraction: 0                             |                                                                      |
|             1.5 |                |                 | Сообщение об ошибке сразу после некорр. ввода        | Регр. тест реакции на некорректный ввод - только целые числа!        |
|               3 |            1.5 |                 | Сообщение об ошибке сразу после некорр. ввода        |                                                                      |
|            blah |                |                 | Сообщение об ошибке сразу после некорр. ввода        | Вообще не число!                                                     |
| <пустая строка> |                |                 | Сообщение об ошибке сразу после некорр. ввода        |                                                                      |
|               3 |              2 |               * | Result of multiplication: 6                          | Тестируем новую фичу!                                                |
|              -3 |              2 |               * | Result of multiplication: -6                         |                                                                      |
|              -5 |              5 |               * | Result of multiplication: 25                         | Убедимся, что "минус на минус даёт плюс"                             |
|               0 |              5 |               * | Result of multiplication: 0                          |                                                                      |
|               5 |              0 |               * | Result of multiplication: 0                          | "От перестановки множителей..." - может, слегка избыточный сценарий  |
|   1000000000000 |  1000000000000 |               * | Result of multiplication: 1000000000000000000000000  | См. комментарий после таблицы                                        |
|  -1000000000000 |  1000000000000 |               * | Result of multiplication: -1000000000000000000000000 | Самый длинный результат при выводе на экран - убедимся, что работает |
|               6 |              3 |               / | Result of division: 2                                | Можно и 2.0 - здесь нам не так важно кол-во цифр после точки         |
|               5 |              2 |               / | Result of division: 2.5                              | Дроби                                                                |
|               5 |              2 |               / | Result of division: 1.6666....                       | Бесконечная десятичная дробь                                         |
|              -5 |              2 |               / | Result of division: -1.6666....                      |                                                                      |
|              -5 |             -2 |               / | Result of division: 1.6666....                       |                                                                      |
|   1000000000000 |  1000000000000 |               * | Result of division: 1                                |                                                                      |
|  -1000000000000 | -1000000000000 |               - | Result of division: 1                                |                                                                      |
|               0 |              1 |               / | Result of division: 0                                |                                                                      |
|              -0 |              1 |               / | Result of division: 0                                | "Минус ноль"? А так можно было?                                      |
|               1 |              0 |               / | Сообщение об ошибке деления на ноль                  | "На ноль делить нельзя!"                                             |
|               1 |              0 |            blah | I don't understand you!                              | "Третья" фича!                                                       |
|               1 |              0 | <пустая строка> | I don't understand you!                              |                                                                      |
