...
print("Вместе " + first_car_make + " и " + second_car_make + " cтоят " + str(total_price) + " рублей!")
print("Начинайте откладывать!")
```

Рассмотреть скобки во избежание конкатенации?
```python
print("Вместе " + first_car_make + " и " + second_car_make + " cтоят " + (first_car_price + second_car_price) + " рублей!")
```
