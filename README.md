...
3. При этом важно всегда инициализировывать переменные правильными значениями. Это важно не только в контексте работы циклов, но цикл просто не выполнится, если мы в его условии сошлёмся на ещё не объявленную переменную, либо значение переменной будет таким, что условие цикла не выполнится.
