...
2. Ввести первое число `3`.
3. Ввести второе число `5`.
4. Ввести код операции `-`.
...
Всё описанно выглядит весьма занудно, но в процессе разработки программы (который включает себя тестирование!) важна кристальная ясность мышления, и эти действия помогают организовать процесс мышления, как и другие приёмчики, о которых я уже рассказал и расскажу дальше.
