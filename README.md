...
Также посмотри примеры *условного ветвления* на визуальных языках.

На языке [блок-схем](https://ru.wikipedia.org/wiki/%D0%91%D0%BB%D0%BE%D0%BA-%D1%81%D1%85%D0%B5%D0%BC%D0%B0) (это такой псевдокод для более наглядного представления программ):
...
Видишь, мы, по сути, оформляем то же самое, но текстом. Большинство языков программирования текстовые.
