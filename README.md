...
Довольно простое задание, его можно делать для того, чтобы просто вспомнить какие-то подзабытые моменты из пройденного. Напиши программу, спрашивающую у пользователя его имя, а затем возраст в следующем виде (имя "Денис" и возраст 42 пользователь, очевидно, ввёл в ответ на запрос программы):
```
...
После вертикального отступа приведён возможный вариант программы.
