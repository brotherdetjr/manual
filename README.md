...
При этом учебник всё-таки не подходит совсем маленьким детям, не знающим, например, значение слова "концепция". С другой стороны, этот текст будет довольно легко упростить до нужного уровня, но сочинять совсем детский учебник мне пока не интересно.
